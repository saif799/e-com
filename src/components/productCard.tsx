...
export default function ProductCard({href, imageUrl , productTitle, brand , price , category , className }: ProductImageProps) {
  return (
    <Link href={`/products/${href}`} className={cn(className,"w-full flex flex-col gap-5 py-4 hover:scale-105 rounded-2xl hover:bg-gray-50 transition-transform min-w-44")}>
